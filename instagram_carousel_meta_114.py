...
GITHUB_TOKEN  = "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"
...
ACCOUNTS = [
    ...
    # Couleurs : Rose saumon (#FFB6C1) / Blanc
    {
        ...
        "posting_schedule": [
            {"window": "midi", "target_hour": 12, "target_minute": 0,  "variation": 30},
            {"window": "soir", "target_hour": 19, "target_minute": 30, "variation": 30},
        ],
    ...
    # Couleurs : Noir (#000000) / Blanc
    {
        ...
        "description":        DESCRIPTION_DEFAULT,
        "posting_schedule": [
            {"window": "midi", "target_hour": 12, "target_minute": 30, "variation": 30},
            {"window": "soir", "target_hour": 20, "target_minute": 0,  "variation": 30},
        ],
        "promo_image_url": "https://raw.githubusercontent.com/Kezzow/instagram-images/main/promo_image.jpg",
    },
    ...
    # Niche : Femme independante & Ambition | Couleurs : Blanc (#FFFFFF) / Noir
    {
        ...
        "description":        DESCRIPTION_DEFAULT,
        "posting_schedule": [
            {"window": "midi", "target_hour": 13, "target_minute": 0,  "variation": 30},
            {"window": "soir", "target_hour": 20, "target_minute": 30, "variation": 30},
        ],
        "promo_image_url": "https://raw.githubusercontent.com/Kezzow/instagram-images/main/promo_image.jpg",
    },
    ...
    # Niche : Glow Up & Self-Worth | Couleurs : Noir (#000000) / Blanc
    {
        ...
        "description":        DESCRIPTION_DEFAULT,
        "posting_schedule": [
            {"window": "midi", "target_hour": 13, "target_minute": 30, "variation": 30},
            {"window": "soir", "target_hour": 21, "target_minute": 0,  "variation": 30},
        ],
        "promo_image_url": "https://raw.githubusercontent.com/Kezzow/instagram-images/main/promo_image.jpg",
    },
...
def get_font(size: int):
    """Charge Times New Roman avec fallback automatique"""
    candidates = [
        "times.ttf",
        "Times New Roman.ttf",
        "timesnewroman.ttf",
...
def create_citation_image(quote: str, account_config: dict, output_path: str) -> str:
    ...
    # Handle discret en bas à droite
    handle       = account_config["handle"]
    handle_color = "#999999" if bg_color.upper() == "#FFFFFF" else "#AAAAAA"
    draw.text((width - 50, height - 40), handle, fill=handle_color, font=handle_font, anchor="ra")
...
def post_carousel_now(account_config: dict) -> bool:
    ...
    try:
        ...
        # ── 6. Nettoyage ──
        for path in [carousel_path, story_path]:
...
def main_loop():
    ...
    while True:
        now = datetime.now()
        logger.info(f"⏰ {now.strftime('%H:%M')}")
